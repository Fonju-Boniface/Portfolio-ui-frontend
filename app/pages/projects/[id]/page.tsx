    ...
    <div className="">
      ...
      <div className="mt-4 grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {[
          ...
          <div key={group} className="flex flex-col items-start p-2 rounded-lg shadow-md hover:shadow-lg transition duration-300
            ...
            <div className="flex flex-wrap">
              {Array.isArray(project[group]) && project[group].length > 0 ? (
                project[group].map((tag) => (
                  <span
                    key={tag}
                    className="bg-primary rounded-md px-2 py-1 m-1"
                  >
                    {tag}
                  </span>
                ))
                ...
                <span className="text-gray-500">
                  No {group.replace(/([A-Z])/g, " $1").toLowerCase()} used for
                  this project.
                </span>
              )}
            </div>
