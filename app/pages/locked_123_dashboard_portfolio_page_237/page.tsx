...
const Dashboard = () => {
  ...
  return (
    <div className="relative  ">
      ...
      {/* Display Active Tab Content Outside the Drawer */}
      ...
      {/* Drawer for Tab Selection */}
      <div className={` w-[200px]  h-[calc(100vh-3rem)] fixed bottom-0 right-0  dark:bg-zinc-900
        bg-zinc-100 transition-all p-1  ${!isVisible ? " rounded-tl-lg right-[-200px]" : ""}`}>
          <Button
            variant="outline"
